(() => {
        ...
        function r(e, r) {
          for (var a = {}, c = [], i = 0; i < e.length; i++) {
            ...
            if (-1 !== p) t[p].references++, t[p].updater(f);
              ...
              var v = o(f, r);
              (r.byIndex = i), t.splice(i, 0, { identifier: l, updater: v, references: 1 });
            }
            c.push(l);
          }
          return c;
  ...
  (n.n = (e) => {
    ...
    (() => {
      function e() {
        console.log("I think this should be printed to the console!");
      }
      var t = n(379),
        r = n.n(t),
        o = n(795),
      ...
      (m.styleTagTransform = f()),
        ...
        document.body.append(
          (function () {
            ...
            return (
              n.classList.add("console-btn"),
              (n.innerHTML = "Click Here"),
              (n.onclick = e),
              t.appendChild(n),
              n
            );
